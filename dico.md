...
<strong>dans l'Idex :</strong> « L’Université cible a pour ambition un rayonnement international lui permettant d’être attractive dans un environnement académique concurrentiel, visible dans les principaux classements internationaux, et d'être intégrée aux réseaux européens et internationaux » (page 24)
